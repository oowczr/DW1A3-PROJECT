...
// http://www.mpu.mp.br/portal_javascripts/event-registration.js?original=1
...
// http://www.mpu.mp.br/portal_javascripts/register_function.js?original=1
...
/* - cssQuery.js - */
// http://www.mpu.mp.br/portal_javascripts/cssQuery.js?original=1
...
// http://www.mpu.mp.br/portal_javascripts/plone_javascript_variables.js?original=1
var portal_url='http://www.mpu.mp.br';var form_modified_message='O seu formulário não foi salvo. Todas as alterações efetuadas serão perdidas';var form_resubmit_message='Você já clicou no botão de envio. Você realmente quer enviar este formulário novamente?';var external_links_open_new_window=false;var external_links_in_content_only=true;

/* - nodeutilities.js - */
// http://www.mpu.mp.br/portal_javascripts/nodeutilities.js?original=1
...
/* - cookie_functions.js - */
// http://www.mpu.mp.br/portal_javascripts/cookie_functions.js?original=1
...
/* - fullscreenmode.js - */
// http://www.mpu.mp.br/portal_javascripts/fullscreenmode.js?original=1
...
/* - select_all.js - */
// http://www.mpu.mp.br/portal_javascripts/select_all.js?original=1
...
/* - dropdown.js - */
// http://www.mpu.mp.br/portal_javascripts/dropdown.js?original=1
...
function redireciona(combo){window.location=combo.value}
function blank(combo){window.open(combo.value)}


/* - dragdropreorder.js - */
// http://www.mpu.mp.br/portal_javascripts/dragdropreorder.js?original=1
var ploneDnDReorder={}
...
// http://www.mpu.mp.br/portal_javascripts/mark_special_links.js?original=1
...
// http://www.mpu.mp.br/portal_javascripts/collapsiblesections.js?original=1
...
// http://www.mpu.mp.br/portal_javascripts/highlightsearchterms.js?original=1
...
/* - se-highlight.js - */
// http://www.mpu.mp.br/portal_javascripts/se-highlight.js?original=1
...
// http://www.mpu.mp.br/portal_javascripts/first_input_focus.js?original=1
...
// http://www.mpu.mp.br/portal_javascripts/folder_contents_filter.js?original=1
...
// http://www.mpu.mp.br/portal_javascripts/folder_contents_hideAddItems.js?original=1
...
/* - styleswitcher.js - */
// http://www.mpu.mp.br/portal_javascripts/styleswitcher.js?original=1
function setActiveStyleSheet(title,reset){if(!W3CDOM){return false};var i,a,main;for(i=0;(a=document.getElementsByTagName("link")[i]);i++){if(a.getAttribute("rel").indexOf("style")!=-1&&a.getAttribute("title")){a.disabled=true;if(a.getAttribute("title")==title){a.disabled=false}}}
if(reset==1){createCookie("wstyle",title,365)}};
function setStyle(){var style=readCookie("wstyle");if(style!=null){setActiveStyleSheet(style,0)}};registerPloneFunction(setStyle);

/* - table_sorter.js - */
// http://www.mpu.mp.br/portal_javascripts/table_sorter.js?original=1
...
// http://www.mpu.mp.br/portal_javascripts/calendar_formfield.js?original=1
...
/* - calendarpopup.js - */
// http://www.mpu.mp.br/portal_javascripts/calendarpopup.js?original=1
function showDay(date){document.getElementById('day'+date).style.visibility='visible';return true}
function hideDay(date){document.getElementById('day'+date).style.visibility='hidden';return true}


/* - ie5fixes.js - */
// http://www.mpu.mp.br/portal_javascripts/ie5fixes.js?original=1
...
/* - formUnload.js - */
// http://www.mpu.mp.br/portal_javascripts/formUnload.js?original=1
...
/* - sarissa.js - */
// http://www.mpu.mp.br/portal_javascripts/sarissa.js?original=1
...
/* - login.js - */
// http://www.mpu.mp.br/portal_javascripts/login.js?original=1
...
// http://www.mpu.mp.br/portal_javascripts/formsubmithelpers.js?original=1
